# AI Development Rules for TeleCLI

These rules govern the development and behavior of AI agents within the TeleCLI project. They are derived from project documentation, including WARP.md, KIRO_INSTRUCTIONS.md, and Copilot instructions.
